var store = [{
        ...
        "excerpt":"Definition and Objective A Command and Control (C&amp;C) is a software system designed to control a client from a server. It allows an operator to execute malware or other commands on remote machines. This document explains the basic implementation of a simple C&amp;C project. Simple C&amp;C Project GitHub Link: Simple...","categories": ["programming"],
        "tags": ["python","malware","C&C","programming"],
        "url": "http://localhost:4000/CommandAndControl/",
        "teaser":"http://localhost:4000/assets/images/Command-And-Control/cAndc.jpg"},{
